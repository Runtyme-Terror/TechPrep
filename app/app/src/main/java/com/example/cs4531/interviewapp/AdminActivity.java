...
public class AdminActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener  {
     ...
     * @author David
     * @param myView
     * This function transitions to FeedbackActivity
     */
    public void switchToUserSubmission(View myView) {
        Intent myIntent = new Intent(this, UserSubmissionActivity.class);
